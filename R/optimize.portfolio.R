...
#' @param objectives default NULL, a list of objective objects
#' @param optimize_method one of "DEoptim", "random", "pso", "GenSA", "ROI", or "CVXR"
#' @param search_size integer, how many portfolios to test, default 20,000
...
#' @param mincov number of observations that must be present in variances and
#' covariances for an asset to be retained in rebalancing windows without
...
#' }
#' @export
optimize.portfolio.rebalancing <- function(R, portfolio=NULL, constraints=NULL, objectives=NULL, optimize_method=c("DEoptim", "random", "ROI", "CVXR"), search_size=20000, trace=FALSE, ..., rp=NULL, rebalance_on=NULL, training_period=NULL, rolling_window=NULL, mincov=3)
{
  stopifnot("package:foreach" %in% search() || requireNamespace("foreach",quietly=TRUE))
